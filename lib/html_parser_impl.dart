...
class HtmlParserImpl implements HtmlParser {
  ...
  HtmlBlockTypeEnum _detectBlockType(String block) {
    ...
    if (b.contains(HtmlParserStrings.spanOpenTag)) return HtmlBlockTypeEnum.span;
    ...
    if (!b.startsWith(HtmlParserStrings.tagOpenPrefix)) return HtmlBlockTypeEnum.plainText;
