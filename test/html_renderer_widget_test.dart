  ...
  group('HtmlRender widget', () {
    testWidgets('renders paragraph from HTML', (tester) async {
      await tester.pumpWidget(
          MaterialApp(home: HtmlRenderer(html: '<p>Hello World</p>')));
      expect(find.text('Hello World'), findsOneWidget);
    });

    testWidgets('renders heading from HTML', (tester) async {
      await tester
          .pumpWidget(MaterialApp(home: HtmlRenderer(html: '<h1>Title</h1>')));
    ...
    testWidgets('renders unordered list', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: BuildUnorderedListWidget(
              block: '<ul><li>Item 1</li><li>Item 2</li></ul>'),
        ),
      );
    ...
    testWidgets('renders ordered list', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
            home: BuildOrderedListWidget(
                block: '<ol><li>First</li><li>Second</li></ol>')),
      );
    ...
    testWidgets('renders error widget for unknown block', (tester) async {
      await tester.pumpWidget(
          MaterialApp(home: HtmlErrorWidget(block: 'unknown block')));
